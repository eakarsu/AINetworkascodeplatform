...
// Automated
// Automated provisioning (slice creation workflow)

export default function GapAutomated() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-automated', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Automated</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Automated provisioning (slice creation workflow)</p>
