...
// Oss Bss
// OSS/BSS integration (Amdocs, Openet) webhooks

export default function GapOssBss() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-oss-bss', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Oss Bss</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>OSS/BSS integration (Amdocs, Openet) webhooks</p>
