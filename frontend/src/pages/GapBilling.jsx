...
// Billing
// Billing integration (operator chargeback)
...
export default function GapBilling() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-billing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Billing</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Billing integration (operator chargeback)</p>
