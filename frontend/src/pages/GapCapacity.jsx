...
// Capacity
// Capacity planning AI predicting bandwidth demand 6-12 months out

export default function GapCapacity() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-capacity', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Capacity</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Capacity planning AI predicting bandwidth demand 6-12 months out</p>
