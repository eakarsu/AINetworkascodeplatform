...
// Feature: Compliance
// Description: Compliance reporting (SLA, uptime SLO dashboards)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Compliance. Compliance reporting (SLA, uptime SLO dashboards)' },
